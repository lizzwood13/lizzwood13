...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=d97bcca706a3fce24a3bd869dd810322"
fetch(apiURL)
...
const forecastAPI = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=d97bcca706a3fce24a3bd869dd810322"
fetch(forecastAPI)
    .then((response) => response.json())
    .then((forecastObject) => {
